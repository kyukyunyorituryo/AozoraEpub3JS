...
AozoraEpub3JSの説明
------------
[電書協EPUB3制作ガイド](http://ebpaj.jp/counsel/guide)のEPUBに近づけることを目的としたフォーク版。改造版AozoraEpub3をベースにJavaScriptに移植に移植している。
...
------------
#### コマンドラインからの実行
　Usage: node AozoraEpub3 \[-options] input_files(txt,zip)
